		...
		<div class="container">
			...
			<div class="header-info">
				...
				<%-- <div class="header-right login">
					<a href="my"><span class="glyphicon glyphicon-user" aria-hidden="true">${user.username}</span></a>
				</div> --%>
				<div class="header-right cart">
					<a href="cart">
						<span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"><span class="card_num">${order.amount==null ? 0 :order.amount}</span></span>
					</a>
				</div>
				<div class="header-right login">
					<a href="my"><span class="glyphicon" aria-hidden="true">${user.username}</span></a>
				</div>
