...
public class IndexController{
	...
	public String index(HttpServletRequest request){
		...
		request.setAttribute("top1List", topService.getList(Tops.TYPE_SCROLL));
		request.setAttribute("top2List", topService.getList(Tops.TYPE_LARGE));
		request.setAttribute("top3List", topService.getList(Tops.TYPE_SMALL));
